...
impl std::ops::AddAssign for UsageMetadata {
    fn add_assign(&mut self, other: Self) {
        ...
        self.cached_content_token_count = add_optional_u64(
            self.cached_content_token_count,
            other.cached_content_token_count,
        );
        self.candidates_token_count =
            add_optional_u64(self.candidates_token_count, other.candidates_token_count);
        self.tool_use_prompt_token_count = add_optional_u64(
            self.tool_use_prompt_token_count,
            other.tool_use_prompt_token_count,
        );
        self.thoughts_token_count =
            add_optional_u64(self.thoughts_token_count, other.thoughts_token_count);
...
impl From<UsageMetadata> for ai_ox_common::usage::TokenUsage {
    fn from(meta: UsageMetadata) -> ai_ox_common::usage::TokenUsage {
        ai_ox_common::usage::TokenUsage {
            ...
            tool_prompt_tokens: meta.tool_use_prompt_token_count,
